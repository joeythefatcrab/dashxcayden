      ...
      <div ref={ref} className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <motion.button
            ...
            className="group relative px-8 py-4 bg-gradient-to-r from-[#7A9B76] to-[#A8B5A1] text-white rounded-full text-lg flex items-center gap-2 shadow-2xl shadow-[#A8B5A1]/50 hover:shadow-[#7A9B76]/60 overflow-hidden"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            transition={{ type: "spring", stiffness: 400, damping: 17 }}
            className="group px-8 py-4 bg-white/80 backdrop-blur-sm text-gray-800 rounded-full text-lg border-2 border-[#C8A99A] shadow-xl hover:bg-white flex items-center gap-2"
          >
