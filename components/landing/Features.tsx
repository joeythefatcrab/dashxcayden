...
function FeatureCard({ feature, index }: { feature: typeof features[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 1, delay: index * 0.15, type: "spring", stiffness: 100, damping: 15 }}
      className="group"
    >
      <motion.div
        whileHover={{ y: -20, rotateZ: 2, scale: 1.05 }}
      ...
      >
        ...
        <motion.div
          ...
          transition={{ type: "spring", stiffness: 200, damping: 15, rotate: { duration: 0.6 } }}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div ref={ref} className="text-center mb-20">
          <motion.div
            ...
            animate={isInView ? { opacity: 1, scale: 1, rotateZ: 0 } : { opacity: 0, scale: 0, rotateZ: -180 }}
