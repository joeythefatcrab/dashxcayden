        ...
        >
          <Link href="/signup-gate">
            <motion.div
              ...
              className="group px-8 py-4 bg-gradient-to-r from-[#7A9B76] to-[#A8B5A1] text-white rounded-full text-lg flex items-center gap-2 shadow-2xl shadow-[#A8B5A1]/50 hover:shadow-[#7A9B76]/60 cursor-pointer"
            >
              Start Free Today
              <motion.div
                animate={{ x: [0, 5, 0] }}
          ...
          <Link href="/sign-in">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              transition={{ type: "spring", stiffness: 400, damping: 17 }}
              className="px-8 py-4 bg-white/80 backdrop-blur-sm text-[#5A5A4E] rounded-full text-lg border border-[#C8A99A] shadow-xl shadow-[#D4C4B5]/50 hover:border-[#A8B5A1] cursor-pointer"
            >
              Sign In
            </motion.div>
          </Link>
