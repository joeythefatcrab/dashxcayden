      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.div
            ...
            animate={isInView ? { scale: 1, rotate: 0, x: -40, y: -40 } : { scale: 0, rotate: -180, x: 0, y: 0 }}
          ...
          >
            {[...Array(5)].map((_, i) => (
              <motion.div
                ...
                animate={isInView ? { scale: 1, rotate: 0 } : { scale: 0, rotate: -360 }}
                transition={{ duration: 0.8, delay: 0.6 + i * 0.1, type: "spring", stiffness: 200, damping: 15 }}
